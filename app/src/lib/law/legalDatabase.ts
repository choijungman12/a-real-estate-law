...
export const LEGAL_DATABASE: LegalEntry[] = [
  ...
  },
  {
    ...
    content:
      '① 조합을 설립하려는 경우 정비구역 지정·고시 후 위원장 포함 5명 이상의 위원과 토지등소유자 과반수의 동의를 받아 추진위원회를 구성하여 시장·군수등의 승인을 받아야 한다. (시행령 §31에 따라 토지등소유자 과반수 동의 필요)',
    url: 'https://www.law.go.kr/lsInfoP.do?lsiSeq=245699',
    relatedArticles: ['제8조', '제38조', '제41조'],
  },
  {
    id: 'l002-2',
    category: '법률',
    title: '도시 및 주거환경정비법',
    article: '제8조 (정비계획의 입안)',
    content:
      '① 정비계획의 입안권자는 정비구역 지정 전 토지등소유자가 입안을 제안하는 경우 일정 비율(통상 1/2 이상) 이상의 동의를 받아 입안을 제안할 수 있다. (서울 조례 §6 — 50% 동의 + 노후·과소·접도 요건)',
    url: 'https://www.law.go.kr/lsInfoP.do?lsiSeq=245699',
    relatedArticles: ['시행령 §8', '서울조례 §6'],
  },
  {
    id: 'l003',
    category: '법률',
